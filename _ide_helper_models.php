 ...
 * @property int $status 0:待发布 1:已发布 2:下架
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|NoticeCategory whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|NoticeCategory whereDeletedAt($value)
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|NoticeCategory whereStatus($value)
 * @method static \Illuminate\Database\Eloquent\Builder|NoticeCategory whereUpdatedAt($value)
 */
